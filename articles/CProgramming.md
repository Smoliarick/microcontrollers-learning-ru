...
- Если в макросе с аргументами использовать соответствующие по типу аргументы, то нет необходимости иметь несколько различных макросов `max` для различных типов данных, как это было с функциями
